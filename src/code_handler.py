...
class Code_Handler():
    ...
    def recurse_line(self, variables, line):
        ...
        for i in range (1, len(split_line)):
            ...
            if split_line[i] in variables:
                ...
                line = self.recurse_line(variables, line.replace(split_line[i], variables.get(split_line[i])))
                #print("replace", line)
    ...
    def handle_code(self, code_input, turtle, text_output):
        ...
        #                     print("sh", second_half)
        #                     unpacked_contents = self.recurse_line(variables, second_half)
        #                     print(unpacked_contents)
        #                     if unpacked_contents[0] == "(":
        #                         result = eval(unpacked_contents[1:len(unpacked_contents)-1])
        #                         line = line[:len(split_line[0])] + "("+str(int(result))+")"
        #                     #line = line[:len(split_line[0])] + result
        #                     print("replace", line)
